...
export default function ResearchProfilePage() {
  ...
  useEffect(()=>{ if (currentUser?.id) getProfile(currentUser.id).then((r)=>setProfile(r.data)) },[currentUser])
